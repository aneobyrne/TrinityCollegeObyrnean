...
#set_property PACKAGE_PIN V13 [get_ports {c2}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {c2}]
	
#set_property PACKAGE_PIN V3 [get_ports {c3}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {c3}]
	
#set_property PACKAGE_PIN W3 [get_ports {c4}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {c4}]
	
#set_property PACKAGE_PIN U3 [get_ports {c5}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {c5}]
	
#set_property PACKAGE_PIN P3 [get_ports {overflow}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {overflow}]
